...
#ifndef OPENNAV_DYNAMIC_FOLLOWING__CONTROLLER_HPP_
#define OPENNAV_DYNAMIC_FOLLOWING__CONTROLLER_HPP_
...
{
/**
 * @class opennav_dynamic_following::Controller
 * @brief Default control law for approaching a target
 */
class Controller
{
public:
...
#endif  // OPENNAV_DYNAMIC_FOLLOWING__CONTROLLER_HPP_
